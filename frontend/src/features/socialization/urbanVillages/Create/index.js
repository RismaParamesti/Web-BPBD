...
const UrbanVillageForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate(`${basePath}/UrbanVillage/Detail/${newId}`);
    ...
    <div className="max-w-6xl mx-auto bg-base-100 p-8 rounded-lg shadow space-y-8">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-primary mt-4">
          Tambah Data <span className="text-secondary">Kelurahan Tangguh</span>
        </h1>
      </div>
...
export default UrbanVillageForm;
