...
const UrbanVillageDetail = () => {
  ...
  useEffect(() => {
    fetch(`https://api.satudatabidangpk.com/urban_village/${id}`)
      .then((res) => res.json())
      .then((res) => {
          ...
          {(userRole === "admin" || userRole === "superadmin") && (
            <>
              <button
                ...
                onClick={() =>
                  navigate(`${basePath}/UrbanVillage/Edit/${data.id}`)
                }
              >
                Edit Data
              </button>
...
export default UrbanVillageDetail;
