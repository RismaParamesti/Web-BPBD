...
const EducationUnitEdit = () => {
  ...
  const [form, setForm] = useState({
    ...
    instance: "", // string instance pendidikan (swasta/negeri)
  ...
  useEffect(() => {
    // Ambil data unit pendidikan berdasar id
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate(`${basePath}/EducationUnit/Detail/${id}`);
    } catch (err) {
      console.error(err);
